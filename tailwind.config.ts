  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        dyslexia: ["var(--font-family-dyslexia)", "Comic Sans MS", "cursive"],
      },
      spacing: {
        "tap": "44px",
        "18": "4.5rem",
      ...
      boxShadow: {
        "soft": "0 4px 24px -8px hsl(var(--foreground) / 0.08)",
        "soft-lg": "0 8px 40px -12px hsl(var(--foreground) / 0.12)",
        "soft-xl": "0 12px 48px -16px hsl(var(--foreground) / 0.15)",
