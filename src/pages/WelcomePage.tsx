      ...
      <div className="relative z-10 min-h-screen flex flex-col bg-transparent">
        ...
        <main id="main-content" className="flex-1 pb-24">
          <div className="container mx-auto px-3 py-6">
            ...
            {/* Disclaimer */}
            <div className="py-12">
              <div className="bg-status-warning-bg border-2 border-status-warning-border rounded-2xl p-4 max-w-lg mx-auto shadow-md">
            ...
            <div className="py-12 flex items-center justify-center">
              <div className="bg-background rounded-2xl p-6 shadow-md border border-border max-w-sm mx-auto w-full">
